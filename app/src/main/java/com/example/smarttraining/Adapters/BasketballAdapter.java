...
public class BasketballAdapter extends RecyclerView.Adapter<BasketballAdapter.ItemViewHolder> {

	private Activity context;
	private List<BasketBall> dataList;
	private RoomDBHistory database;

	public BasketballAdapter(Activity context, List<BasketBall> dataList) {
	...
	public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
		BasketBall data = dataList.get(position);
		...
		holder.deleteButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				BasketBall d = dataList.get(holder.getAdapterPosition());
				database.basketBallDao().deleteItem(d);
